...
export default function AddTournamentForm({
  ...
  async function onSubmit(values: z.infer<typeof schema>) {
    ...
    const notificationPromise = sendNotifications(
      `${tournament.title} #${tournament.slug.substring(
        tournament.slug.length - 4
      )}`,
      "New touranament created! Click here to check it out!",
